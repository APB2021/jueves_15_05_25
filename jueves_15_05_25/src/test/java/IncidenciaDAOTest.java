...
public class IncidenciaDAOTest {
    ...
    public void testCrearYBuscar() {
        Incidencia i = new Incidencia(0, "Pantalla azul", "Error grave", LocalDate.now(), "Abierta", "Juan", "juan@ejemplo.com");
    ...
    public void testActualizarEstado() {
        Incidencia i = new Incidencia(0, "Problema de red", "No hay conexión", LocalDate.now(), "Abierta", "Ana", "ana@ejemplo.com");
        dao.crear(i);
    ...
    public void testEliminarPorId() {
        Incidencia i = new Incidencia(0, "Eliminar esto", "Solo para test", LocalDate.now(), "Abierta", "Luis", "luis@ejemplo.com");
        dao.crear(i);
    ...
    public void testBuscarConFecha() {
        Incidencia i = new Incidencia(0, "Con fecha", "Test fecha", LocalDate.of(2024, 1, 1), "Abierta", "Mario", "mario@ejemplo.com");
        dao.crear(i);
    ...
    public void testConcurrenciaPoolConexiones() throws InterruptedException {
        ...
        for (int i = 0; i < 10; i++) {
            int finalI = i;
            tareas.add(() -> {
                Incidencia i1 = new Incidencia(0, "Concurrencia " + finalI, "Test", LocalDate.now(), "Abierta", "Técnico", "t@t.com");
                return dao.crear(i1);
            });
        }
